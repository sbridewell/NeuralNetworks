// <copyright file="AdditionForm.cs" company="Simon Bridewell">
...
namespace Sde.VectorDemo.Winforms.Forms
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdditionForm"/> class.
        /// </summary>
        public AdditionForm()
        {
        ...
        private void ShowResult()
        {
            ...
            {
                var msg = $"Cannot add these vectors because they have different dimensions.{Environment.NewLine}"
