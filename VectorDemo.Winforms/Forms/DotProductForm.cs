// <copyright file="DotProductForm.cs" company="Simon Bridewell">
...
namespace Sde.VectorDemo.Winforms.Forms
{
    ...
    /// <summary>
    /// Form to demonstrate dot product multiplication of two vectors.
    /// </summary>
    public partial class DotProductForm : Form
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DotProductForm"/> class.
        /// </summary>
        ...
        private void ShowResult()
        {
            ...
            {
                var msg = $"Cannot dot product multiply these vectors because they have different dimensions.{Environment.NewLine}"
            ...
            {
                var result = first.MultiplyUsingDotProduct(second);
