// <copyright file="MatrixAdditionForm.cs" company="Simon Bridewell">
...
namespace Sde.MatrixDemo.Forms
{
    ...
    /// </summary>
    public partial class MatrixAdditionForm : Form
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MatrixAdditionForm"/> class.
        /// </summary>
        public MatrixAdditionForm()
        {
        ...
        private void MatrixTextBox_Validated(object? sender, EventArgs e)
        {
            ...
            {
                var msg = "Cannot add these matrices because they have different dimensions." + Environment.NewLine
